...
import { A as AstroError, R as ResponseSentError } from './chunks/astro/server_OhfOa5GV.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
...
async function onRequest$1(context, next) {
  ...
  if (!session?.profile) {
    if (ADMIN_ROUTES.some((r) => pathname.startsWith(r)) || STUDENT_ROUTES.some((r) => pathname.startsWith(r)) || AFFILIATE_ROUTES.some((r) => pathname.startsWith(r))) {
